...
interface NavigationSupport {
    ...
    fun <T : Page, R : Any> T.via2(body: (T) -> R) = body(this)
    fun <T : Page, R : Any> T.via3(body: T.(T) -> R) = body(this, this)
    fun <T : Page, R : Any> T.via4(classValidator: KClass<T>, body: T.() -> R) = body(this)
